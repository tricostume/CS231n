...
#`TwoLayerNet.loss`. This function is very similar to the loss functions you 
#have written for the SVM and Softmax exercises: It takes the data and weights 
#and computes the class scores, the loss, and the gradients on the parameters. 
# 
...
#model we would expect to see more overfitting, which would manifest itself as 
...
#accuracy of greater than 48% on the validation set. Our best network gets over 
#52% on the validation set.
# 
